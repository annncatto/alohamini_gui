class StatusPresenter:
    ...
    def set_connected(self, connected: bool) -> None:
        ...
        self.ui.visual_status.setText(f"运行状态\n{state}")
        self.ui.status_line.setText(f"机器人: {state} | Host: {'运行中' if connected else '未知'} | 最近动作: --")
    ...
    def update_action(self, action: dict) -> None:
        ...
        self.ui.visual_status.setText("运行状态\n遥操中")
        self.ui.status_line.setText(f"机器人: 已连接 | Host: 运行中 | 最近动作: {text}")
